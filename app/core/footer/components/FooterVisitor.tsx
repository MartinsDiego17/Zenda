...
export const FooterVisitor = () => {
  return (
    <footer className="footer-container w-screen border-t bg-card">
      <div className="footer-content mx-auto flex max-w-[70vw] flex-col items-center justify-between gap-4 px-6 py-8 sm:flex-row">
        <Logo />
