...
export const Hero = () => {
    ...
    return (
        <section id="#" className="hero-container relative flex min-h-screen items-center overflow-hidden pt-20">


            <div className="hero-sun relative mx-auto grid w-full max-w-7xl items-center gap-12 px-6 py-16 lg:grid-cols-2 lg:gap-20">
                <div
                    className={`flex hero-content flex-col gap-8 transition-all duration-700 ${visible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                        }`}
                >
                    ...
                    <p className="hero-description max-w-lg text-pretty text-lg leading-relaxed text-muted-foreground">
                ...
                <div
                    className={`hero-image relative transition-all delay-200 duration-700 ${visible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                        }`}
                >
                    ...
                    <div className="hero-next-turn absolute -bottom-6 -left-6 rounded-2xl border border-border bg-card p-4 shadow-lg">
                        <div className="flex items-center gap-3">
